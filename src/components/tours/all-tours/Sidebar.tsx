  ...
  return (
    <aside className="py-4 px-6 bg-white rounded-xl border border-solid border-border order-2 md:order-1 md:h-[630px]">
      <div className="flex flex-col gap-3">
        ...
        <CheckFilter name="Tour Type" filters={TOUR_TYPE} field="type"/>
        <CheckFilter name="Filter Price" isPrice field="price"/>
        <CheckFilter name="Duration" filters={TOUR_DURATION} field="duration"/>
